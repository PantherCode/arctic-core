...
/*
    ...
    public void T01_EventMessage_Constructor() {
        ...
        Assert.assertEquals(eventMessage.eventHandler(), EVENT_HANDLER, "Actual value of event responseHandler");

        Assert.assertEquals(eventMessage.responseHandler(), MESSAGE_HANDLER, "Actual value of message responseHandler");
